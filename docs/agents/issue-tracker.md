...
`.scratch/` is gitignored. Tickets here reference customer identifiers and
production volumes, and this repo is publicly visible — working state stays
out of git, the same way `input/` and `output/` do.
