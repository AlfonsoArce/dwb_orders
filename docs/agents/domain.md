...
## File structure
    ...
    ├── CONTEXT.md
    ├── docs/adr/
    │   ├── 0001-timestamptz-with-assumed-eastern.md
    │   └── 0002-surrogate-key-with-source-discriminator.md
    └── ...
...
> _Contradicts ADR-0002 (surrogate key with source discriminator), but worth
> reopening because…_
